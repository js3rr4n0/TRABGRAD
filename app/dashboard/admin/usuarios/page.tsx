'use client';
import { Plus, Search, Edit3, Eye, MoreHorizontal, Check, X, Loader2, Trash2, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="flex flex-wrap items-center justify-between bg-white p-4 rounded-2xl shadow-sm border border-gray-100 gap-4">
        <div className="relative flex-1 min-w-[300px]">
          ...
          <input 
            ...
            className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2 text-sm text-gray-900 placeholder-gray-500 font-medium focus:outline-none focus:border-[#c92a2a] focus:ring-1 focus:ring-[#c92a2a] transition-all"
          />
        </div>
